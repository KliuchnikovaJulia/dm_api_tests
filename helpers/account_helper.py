...
class AccountHelper:
    def __init__(self, account_api: AccountApi, mailhog_api: MailhogApi, login_api: LoginApi):
    ...
    def register_new_user(self, login: str, email: str, password: str):
        ...
        response = self.account_api.put_v1_account_token(token=activation_token)
    ...
    def find_token(self, login: str):
        response = self.mailhog_api.get_v2_messages(limit=10)
